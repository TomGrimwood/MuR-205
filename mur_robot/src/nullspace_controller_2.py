...
def controller(data):
	...
	if diff_time.to_nsec()>5000000:
		...
		#print "current_time: ",current_time, "diff_time: ", diff_time
		...
		current_point_world=transformer(data)
		...
		print "\n\nspeedx: ",round(speedx,4), "speedy: ",round(speedy,4)
	
		#print "pub: ",diff_time
		#last_publ_time=rospy.rostime.get_time()
		
		pub.publish('speedl(['+str(speedx)+','+str(speedy)+',0,0,0,'+str(speedg)+'], 1.5, 1.5)')
...
def getJointPoseUR():
	...
	global target_Trafo
	target_Trafo= transformer(mir_pose)
