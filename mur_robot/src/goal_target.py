...
class map_navigation():
	...
	def choose(self):
		...
		goal.position.z= pose[2]
		goal.orientation.x= pose[3]
		goal.orientation.y= pose[4]
		goal.orientation.z= pose[5]
		goal.orientation.w= pose[6]
	...
	def __init__(self):
		...
		self.xGoal_3 = 21.718321314
		self.yGoal_3 = 12.4993157814

		self.xGoal_4 = 20.7182686126
		self.yGoal_4 = 12.9096429407
		...
		self.goalReached = self.moveToGoal(goal)
...
##############-- move to the destination --##################
	def moveToGoal(self,goal_target):
