...
class JacobianPublisher():
	...
	# generate delay for ur commmands due to TOTZEIT, delayed by 5 control steps
	ur_command_stack=[]
	stack_size=28
	...
	def callback(self,joint_states,odom,wheel_vel):
		...
		self.actuateJoints(q_dot_ur_feedForward,wheel_speeds)
	...
	def computeJointSpeeds(self,J_extended,derived_cartesian_velocities):
		...
		#print "joint_speeds_list: ",joint_speeds_list

		if len(self.ur_command_stack)>self.stack_size-1:
			print "pop"
			self.ur_command_stack.pop(0)

		

		self.ur_command_stack.append(joint_speeds_list)

		

		

		joint_speeds_list_current=[self.ur_command_stack[0][0],self.ur_command_stack[0][1],self.ur_command_stack[0][2],self.ur_command_stack[0][3],self.ur_command_stack[0][4],self.ur_command_stack[0][5]]
		#print"stack: ",self.ur_command_stack

		#print"joint_speeds_list_current: ",joint_speeds_list_current

		wheel_speeds=[q_dot[0,6],q_dot[0,7]]

		#print "q: ", joint_speeds_list_current
		return joint_speeds_list_current,wheel_speeds	
